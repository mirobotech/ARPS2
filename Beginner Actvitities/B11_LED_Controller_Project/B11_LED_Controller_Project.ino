/* ================================================================================
Activity 11 Extension: LED Controller [B11-LED-Controller-Project]
Version: 1.2
...
loop delay. Each control now has its own update rate:
  ...
  LED4/5 rate:    how often light readings update LED brightness (ms)
...
Controls (same as Activity 10):
  ...
  Q1/Q3   - control LED4/LED5 brightness (if LIGHT_SENSORS_INSTALLED)
=================================================================================*/
// IMPORTANT: Make sure that ARPS2.h is accessible as a tab in this project.
#include "ARPS2.h"      // Define ARPS-2 I/O devices

// ---- Program Configuration -----------
bool LIGHT_SENSORS_INSTALLED = false; // Set true if Q1 and Q3 are installed
...
const int LIGHT_RATE  = 50;           // ms between light reads for LED4/LED5
...
void loop()
{
    ...
    // ---- Light polling timer (if installed) ----
    // TODO: check if LIGHT_RATE ms has elapsed since last_light_time
    //       if so: read Q1_level()/Q3_level() (0-1023), scale to
    //              0-255 (divide by 4 - see Activity 10, GE6),
    //              update LED4/LED5
    //              update last_light_time = current_time
...
FADE_RATE, and LIGHT_RATE. What does this make possible that
