...
NOTE: Only SW2 and SW3 are used here. Arduino UNO Rev 3 users should
be aware that these two pins are shared with the USB serial port -
see the combination lock activity's own note on this for more detail.
=================================================================================*/
