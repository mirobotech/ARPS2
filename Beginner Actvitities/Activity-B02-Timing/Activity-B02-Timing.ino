...
1.  In Activity 1 you learned that the ARPS2.h header file defines
    all of the ARPS-2 I/O devices. (You can open the file in the
...
5.  While microsecond delays are much too short to see, they can be
    ...
    speaker on ARPS-2 needs to be rapidly switched on and off to
...
3.  Really old computers used lights to show binary values. Try to
    simulate a binary counting sequence using ARPS-2's LEDs.
