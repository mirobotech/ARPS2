# ARPS-2 Beginner Activities

Beginner programming activities designed to introduce novices to microcontroller
programming using Arduino code and the ARPS-2 circuit, with the aim of providing
learners with the requisite knowledge to create their own, fully-featured simple
projects such as a Simon-style memory game, a reaction timer game, a room alarm,
a servo driver, an autonomous line-following robot, or a simple classroom Sumo
robot.

These beginner activities combine easy to understand starter code with heavily
scaffolded program analysis and extension activities to introduce and reinforce
fundamental programming concepts. They are designed to be used in an early high
school level computer technology class and can also be used as an introductory
self-study course for use with ARPS-2.
...
* Reaction timer game
* Simple robots (line-follower, classroom Sumo)
* Simple servo driver
* Analog sensor/monitor and controller
